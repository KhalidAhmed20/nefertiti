...
class PurchaseRequestLine(models.Model):
    ...
    sub_penality = fields.Many2one(comodel_name='penality.sub', string="Sub Penality" ,domain="[('penality_group', '=', penality_group)]")
    ...
    type = fields.Selection([("managerial", "Managerial"), ("financial", "Financial")], string="Deduction Type", required=True ,tracking=True)
